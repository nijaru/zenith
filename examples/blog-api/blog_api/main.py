...
configure_auth(
    app,
    secret_key=os.getenv("SECRET_KEY", "dev-secret-key-that-is-long-enough-for-development"),
    access_token_expire_minutes=int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", 30)),
    refresh_token_expire_days=int(os.getenv("REFRESH_TOKEN_EXPIRE_DAYS", 7))
)

# Configure database
database_url = os.getenv("DATABASE_URL", "postgresql+asyncpg://blog_user:blog_pass@localhost/blog_api")
