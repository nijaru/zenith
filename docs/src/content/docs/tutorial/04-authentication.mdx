...
Never store passwords in plain text. We'll use bcrypt for secure hashing.
...
def hash_password(password: str) -> str:
    ...
    - Multiple rounds (default 12, adjustable for security/speed)
...
<Card title="Continue to Part 5" icon="arrow-right">
  Ready to test your API? [Continue to Testing →](/tutorial/05-testing)
</Card>
