...
The Service system is Zenith's approach to organizing business logic separately from web concerns. Contexts provide dependency injection, database access, and service composition.
...
```python
from zenith import Service, Inject, Depends
