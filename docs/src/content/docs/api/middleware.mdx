...
<Aside type="note">
Database optimization is built into Zenith and works automatically. No middleware configuration needed.
</Aside>
...
<Aside type="tip">
SSE support is built into Zenith with automatic optimization. Use `create_sse_response()` for streaming.
</Aside>
