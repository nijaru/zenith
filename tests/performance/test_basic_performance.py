...
class TestBasicPerformance:
    ...
    def full_app(self):
        ...
        app = Zenith(
            ...
            middleware=[
                Middleware(
                    SecurityHeadersMiddleware, config=SecurityConfig(force_https=False)
                ),
    ...
    async def test_middleware_overhead(self, minimal_app, full_app):
        ...
        assert (
            overhead_pct < 1500
        )  # < 1500% overhead (TestClient adds significant overhead)
    ...
    async def test_concurrent_request_handling(self, minimal_app):
        ...
        async with TestClient(minimal_app) as client:
            ...
            for concurrency in concurrency_levels:
                ...
                results[concurrency] = {"elapsed": elapsed, "rps": rps}
    ...
    async def test_high_concurrency_load(self):
        ...
        async with TestClient(app) as client:
            ...
            for batch_size in batch_sizes:
                ...
                print(
                    f"Batch {batch_size:3d}: {success_rate:5.1f}% success, {rps:6.1f} req/s"
                )
