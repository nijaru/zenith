...
from zenith.auth.jwt import create_access_token, verify_access_token, JWTManager, configure_jwt
...
class TestJWTTokens:
    ...
    def test_verify_invalid_token(self):
        ...
        wrong_manager = JWTManager(secret_key="wrong-secret-key-that-is-different-and-long-enough")
...
class TestTestingUtilities:
    ...
    def test_create_test_token(self):
        ...
        # Should be decodeable with test secret
        from zenith.testing import TEST_JWT_SECRET
...
class TestAuthenticationMiddleware:
    ...
    async def test_middleware_scope_validation(self):
        ...
        async with TestClient(app) as client:
            ...
            client.set_auth_token("user@example.com", role="user", scopes=["read", "write"])
