...
class TestOpenAPIGenerator:
    ...
    def test_pydantic_model_schema_generation(self):
        ...
        response_schema = spec["paths"]["/users"]["post"]["responses"]["200"]["content"]["application/json"]["schema"]["$ref"]
...
class TestOpenAPICachePerformance:
    ...
    def test_cache_memory_efficiency(self):
        ...
        assert len(generator._spec_cache) > 25  # But more than 25 because it grows after cleanup
