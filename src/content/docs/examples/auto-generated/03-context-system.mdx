---
title: "🏗️ Context System - Business Logic Organization"
description: |
...
# Run the example
uv run python examples/03-context-system.py
```
...
`} lang="python" title="examples/03-context-system.py" />
...
*This page is auto-generated from [`examples/03-context-system.py`](https://github.com/nijaru/zenith/blob/main/examples/03-context-system.py).
