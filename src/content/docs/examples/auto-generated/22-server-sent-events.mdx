---
title: "Server-Sent Events (SSE) Example."
description: |
...
`} lang="python" title="examples/22-server-sent-events.py" />
...
*This page is auto-generated from [`examples/22-server-sent-events.py`](https://github.com/nijaru/zenith/blob/main/examples/22-server-sent-events.py).
