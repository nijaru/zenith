---
title: "Background tasks example for Zenith."
description: "Demonstrates async background task execution."
---
...
# Run the example
uv run python examples/05-background-tasks.py
```
...
`} lang="python" title="examples/05-background-tasks.py" />
...
*This page is auto-generated from [`examples/05-background-tasks.py`](https://github.com/nijaru/zenith/blob/main/examples/05-background-tasks.py).
