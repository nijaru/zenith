---
title: "🌐 Full-Stack SPA Example - Zenith + Frontend Framework"
description: |
...
# Run the example
uv run python examples/17-fullstack-spa.py
```
...
`} lang="python" title="examples/17-fullstack-spa.py" />
...
*This page is auto-generated from [`examples/17-fullstack-spa.py`](https://github.com/nijaru/zenith/blob/main/examples/17-fullstack-spa.py).
