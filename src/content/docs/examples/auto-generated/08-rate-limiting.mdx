---
title: "Rate Limiting Example - Comprehensive Rate Limiting Demo"
description: |
  Demonstrates:
...
# Run the example
uv run python examples/08-rate-limiting.py
```
...
`} lang="python" title="examples/08-rate-limiting.py" />
...
*This page is auto-generated from [`examples/08-rate-limiting.py`](https://github.com/nijaru/zenith/blob/main/examples/08-rate-limiting.py).
