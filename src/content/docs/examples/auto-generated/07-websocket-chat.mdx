---
title: "WebSocket Chat Example - Real-time chat application"
description: |
  Demonstrates:
...
<div class="example-header">
  ...
  <Badge text="WebSocket" variant="note" />
</div>
...
# Run the example
uv run python examples/07-websocket-chat.py
```
...
`} lang="python" title="examples/07-websocket-chat.py" />

## What This Example Demonstrates

**Real-time Communication**: WebSocket connections and message handling
...
*This page is auto-generated from [`examples/07-websocket-chat.py`](https://github.com/nijaru/zenith/blob/main/examples/07-websocket-chat.py).
