---
title: "🔄 Advanced Background Processing - Redis-Powered Job Queues"
description: |
...
# Run the example
uv run python examples/14-advanced-background-processing.py
```
...
`} lang="python" title="examples/14-advanced-background-processing.py" />
...
*This page is auto-generated from [`examples/14-advanced-background-processing.py`](https://github.com/nijaru/zenith/blob/main/examples/14-advanced-background-processing.py).
