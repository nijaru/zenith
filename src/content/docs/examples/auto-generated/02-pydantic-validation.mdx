---
title: "🔍 Pydantic Validation - Type-Safe Request and Response Models"
description: |
...
# Run the example
uv run python examples/02-pydantic-validation.py
```
...
`} lang="python" title="examples/02-pydantic-validation.py" />
...
*This page is auto-generated from [`examples/02-pydantic-validation.py`](https://github.com/nijaru/zenith/blob/main/examples/02-pydantic-validation.py).
