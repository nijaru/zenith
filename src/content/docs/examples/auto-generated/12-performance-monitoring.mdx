---
title: "📊 Zenith Performance Monitoring - Complete Observability Stack"
description: |
...
# Run the example
uv run python examples/12-performance-monitoring.py
```
...
`} lang="python" title="examples/12-performance-monitoring.py" />
...
*This page is auto-generated from [`examples/12-performance-monitoring.py`](https://github.com/nijaru/zenith/blob/main/examples/12-performance-monitoring.py).
