---
title: "🗂️ Router Grouping Example - Clean API Organization"
description: |
...
# Run the example
uv run python examples/15-router-grouping.py
```
...
`} lang="python" title="examples/15-router-grouping.py" />
...
*This page is auto-generated from [`examples/15-router-grouping.py`](https://github.com/nijaru/zenith/blob/main/examples/15-router-grouping.py).
