---
title: "🛡️ Zenith Security Middleware - Complete Production Security Stack"
description: |
...
# Run the example
uv run python examples/11-security-middleware.py
```
...
`} lang="python" title="examples/11-security-middleware.py" />
...
*This page is auto-generated from [`examples/11-security-middleware.py`](https://github.com/nijaru/zenith/blob/main/examples/11-security-middleware.py).
