...
class ExceptionHandlerMiddleware(BaseHTTPMiddleware):
    ...
    async def _handle_zenith_exception(self, request: Request, exc: ZenithException) -> Response:
    ...
    async def _handle_file_not_found(self, request: Request, exc: FileNotFoundError) -> Response:
    ...
    async def _handle_permission_error(self, request: Request, exc: PermissionError) -> Response:
