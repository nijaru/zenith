...
import asyncio
import inspect
from typing import Any, Awaitable, Callable, Dict, List, Optional, Type, TypeVar, Union, get_type_hints
            ...
            for param_name, param in sig.parameters.items():
                ...
                if param.default != inspect.Parameter.empty:
                    if isinstance(param.default, ContextDependency):
                        ...
                        context = await self._app.get_context(context_class.__name__.lower())
                        ...
                        user = get_current_user(request, required=param.default.required)
