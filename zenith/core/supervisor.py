...
class Supervisor:
    ...
    async def _handle_child_failure(self, child: SupervisedTask, exception: Exception) -> None:
        ...
        if not should_restart:
            self.logger.info(f"Not restarting child {child.spec.id} due to restart strategy")
            return
